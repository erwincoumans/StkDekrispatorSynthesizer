...
struct GraphicsPhysicsBridge
{
	...
	virtual void createRigidBodyGraphicsObject(btRigidBody* body,const b3Vector3& color)
	{
	}

	virtual void createCollisionObjectGraphicsObject(btCollisionObject* obj,const b3Vector3& color)
	{
	}
...
public:
	...
	virtual bool pickBody(const b3Vector3& rayFromWorld, const b3Vector3& rayToWorld) = 0;
	virtual bool movePickedBody(const b3Vector3& rayFromWorld, const b3Vector3& rayToWorld)=0;
...
/*
	...
	virtual btBoxShape* createBoxShape(const b3Vector3& halfExtents)=0;
 */
};
